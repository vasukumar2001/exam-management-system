...
namespace ems
{
    public partial class update_examname : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["id"] != null && Request.QueryString["id"] != string.Empty)
                {
                    ...
                    string query = "select * from examdetail where id=" + id;
                    con.Open();
                    ...
                    if (rd.HasRows)
                    {
                        while (rd.Read())
                        {
                            examname.Text = rd[1].ToString();                       
                            programeDropDownList1.SelectedValue = rd[2].ToString();
                            semesterDropDownList2.SelectedValue = rd[3].ToString();
        ...
        protected void submit_Click(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["id"] != null && Request.QueryString["id"] != string.Empty)
            {
                id = Convert.ToInt16(Request.QueryString["id"]);
                con.Open();
                string qurey = "UPDATE  examdetail SET examname='" + examname.Text + "',programe='" + programeDropDownList1.SelectedValue + "', semester='" + semesterDropDownList2.SelectedValue + "'WHERE id='" + id + "'";
