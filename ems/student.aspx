<%@ Page Language="C#" MasterPageFile="~/MainSite.Master" AutoEventWireup="true" CodeBehind="student.aspx.cs" Inherits="ems.index" %>
    ...
    <form id="form1" runat="server"  class="row g-2">
        ...
        <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <asp:RadioButtonList ID="gender" class="form-control" runat="server" AutoPostBack="True" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged" RepeatDirection="Horizontal" >
        ...
        <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="address" runat="server" class="form-control" TextMode="MultiLine" OnTextChanged="address_TextChanged"></asp:TextBox>
                    </div></div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
                ...
                <div class="col-12">
                    <asp:Button ID="submit" runat="server" class="btn btn-primary" Text="Submit" Width="71px" OnClick="submit_Click" />
                           
                    <asp:Button ID="reset" runat="server" class="btn btn-primary" Text="Reset" Width="68px" OnClick="reset_Click" />
                           </div>
