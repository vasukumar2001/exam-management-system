<%@ Page Language="C#" MasterPageFile="~/MainSite.Master" AutoEventWireup="true" CodeBehind="exam.aspx.cs" Inherits="ems.exam1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <form id="form1" runat="server" class="row g-2">
        ...
        <div class="col-12">
            ...
            <asp:Button ID="reset" runat="server" OnClick="reset_Click" Text="Reset" class="btn btn-primary" Width="72px" />
