<%@ Page Language="C#" MasterPageFile="~/MainSite.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="exam_datetime_arrangement.aspx.cs" Inherits="ems.exam" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <form id="form1" runat="server" class="row g-2">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="exam_starttime" class="form-control" runat="server" OnTextChanged="exam_starttime_TextChanged" TextMode="Time"></asp:TextBox>
            </div> </div>
        <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="exam_endtime" class="form-control" runat="server" OnTextChanged="exam_starttime_TextChanged" TextMode="Time"></asp:TextBox>
        </div></div>
        <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="exam_mark" class="form-control" runat="server" OnTextChanged="exam_mark_TextChanged"></asp:TextBox>
        </div></div>
        <div class="col-12">

        <asp:Button ID="Submit" class="btn btn-primary" runat="server" Text="Submit" OnClick="submit_Click" />

        <asp:Button ID="reset" class="btn btn-primary" runat="server" Text="Reset" OnClick="reset_Click" />
            </div>
